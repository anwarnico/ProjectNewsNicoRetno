...
import com.example.projectnewsnicoretno.ui.RetrofitInstance;
...
public class UserRepository {
    private com.example.projectnewsnicoretno.ui.LoginEndPointInterface API;
    ...
    public void getUserFromNetwork(){
        networkExecutor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    List<User> usersFromNetwork = API.checkUserCredential().execute().body();
